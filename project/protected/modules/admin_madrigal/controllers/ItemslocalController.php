...
class ItemslocalController extends Controller
{
    /**
    ...
    public function actionAdmin()
    {
        ...
        $items = Local::model()->findAll(array('condition'=>'t.status != 2', 'order'=>'t.id DESC'));
    ...
    {
        $model=Local::model()->findByAttributes(array('id'=>$id), array('condition'=>'t.status != 2'));
        if($model===null)
            throw new CHttpException(404,'The requested page does not exist.');
        return $model;
    }
