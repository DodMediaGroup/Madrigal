...
class ItemsapartamentController extends Controller
{
    /**
    ...
    public function actionAdmin()
    {
        ...
        $items = DetailsApartment::model()->findAll(array('condition'=>'t.status != 2', 'order'=>'t.id DESC'));
    ...
    public function actionCreate()
    {
        ...
        $model = new DetailsApartment;

        if(isset($_POST['DetailsApartment']))
        {
            $errors = false;

            $model->attributes=$_POST['DetailsApartment'];
    ...
    {
        $model=DetailsApartment::model()->findByAttributes(array('id'=>$id), array('condition'=>'t.status != 2'));
        if($model===null)
            throw new CHttpException(404,'The requested page does not exist.');
        return $model;
    }
