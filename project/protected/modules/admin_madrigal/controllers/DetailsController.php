...
class DetailsController extends Controller
{
    ...
    public function actionAdmin()
    {
        ...
        $details = DetailsProject::model()->findAll(array('condition'=>'t.status != 2', 'order'=>'t.id DESC'));
    ...
    public function actionCreate()
    {
        ...
        $model = new DetailsProject;

        if(isset($_POST['DetailsProject']))
        {
            $errors = false;

            $model->attributes=$_POST['DetailsProject'];
    ...
    {
        $model=DetailsProject::model()->findByAttributes(array('id'=>$id), array('condition'=>'t.status != 2'));
        if($model===null)
            throw new CHttpException(404,'The requested page does not exist.');
        return $model;
    }
