...
<html>
    ...
    <div class="md-modal md-just-me" id="logout-modal">
        <div class="md-content">
            ...
            <div>
                <p class="text-center">¿Seguro quieres salir del sistema de administracion de CoopeVogue?</p>
                <p class="text-center">
                <button class="btn btn-danger md-close">No!</button>
                <a href="<?php echo Yii::app()->createUrl('admin_madrigal/logout') ?>" class="btn btn-success md-close">Si, quiero salir</a>
                </p>
            </div>
        </div>
    </div>        <!-- Modal End -->
